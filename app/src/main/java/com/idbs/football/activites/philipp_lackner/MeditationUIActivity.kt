...
import com.idbs.football.activites.philipp_lackner.ui.theme.*
...
fun HomeScreen() {
    Box(
        ...
        Column {
            GreetingSection()
            ChipSection(chips = listOf("Sweet slep", "Insomnia", "Depression"))
            CurrentMeditation()
...
@ExperimentalFoundationApi
@Composable
fun FeatureSection(features: List<FeatureModel>) {
...
@Composable
fun GreetingSection(name: String = "Sohir") {
    Row(
        horizontalArrangement = Arrangement.SpaceBetween,
        verticalAlignment = Alignment.CenterVertically,
        modifier = Modifier
